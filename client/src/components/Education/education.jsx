...
import picture_sample from './../images/education.png'
    ...
    saveAndContinue=()=>{
      if( this.state.degree==='Custom Degree' )
      {
        const obj={ 
          ...
          city_college : this.state.city_college,
          state_college : this.state.state_college,
          field_of_study : this.state.field_of_study, 
          graduating_year : this.state.graduating_year , 
          degree : this.state.custom_degree , 
              ...
              <Row>
                ...
                <Col>
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Item  onClick={this.changeDegree} className="Master of computer Application-">Master of Computer Application</Dropdown.Item>
